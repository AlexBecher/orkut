...
$arquivo = isset($_FILES["imagemN"]) ? $_FILES["imagemN"] : FALSE;
$max_image_x = 400;
$max_image_y = 400;
$max_thumb_x = 90;
$max_thumb_y = 90;
        ...
        if(is_uploaded_file($arquivo['tmp_name']))
        {
                if(verifica_image($arquivo))
                {
                        ...
                        
                       {
                           ...
                           //verifica se é porno
                           include_once("filter_porn/class.ImageFilter.php");
                           $Obj = new ImageFilter;
                           $percentage = $Obj->GetScore($endFoto);
    ...
    function send_xyCrop()
			{
				...
				$.post('/crop_pp_0029C.php',{x:x_1,w:w_1,h:h_1,y:y_1,name:name_foto,cod:cod_comm},function(){
                
             $('#popup_comp_003993').hide();window.location ='$url_comm';
                });
			};
  </script>
...
<div  style="position: relative; width: 100%; height:550px; padding: 10px"><div id="_lloKJHG627_BB" style="position: relative;width: 450px; height:255px;overflow:auto; margin-left: 20px;">
    <img id="target_0993kknnnd" src="/bg_community/$nome_foto" style="position: relative;auto; "/></div>
    <div style="border: 2px solid #C0C0C0; position: relative; width:155px; max-height:250px; overflow: hidden; margin-top: 40px; margin-left: 20px;">
    <img src="/bg_community/$nome_foto" style="position: relative; " id="preview" alt="Preview" class="jcrop-preview"/></div></div>      
...
html;
                           ...
                           //avisa que imagem não é permitida
...
<div id="popup_comp_003993"  >
   ...
   <div
        class="menu_comp user_foto_borda_superior"
           ...
           style="position: absolute; top: 10px;  height: 21px; right: 10px;"    />
       <label ><label class="urjjdbbfjjd"
                style="font-family: arial, Helvetica, sans-serif; font-size: 14px; font-weight: bold; font-style: normal; font-variant: normal; color: #666666;  position: absolute; top: 16px; left: 10px;">"Não é permitido esse tipo de imagens!"</label></label></div><br />
                
<div  style="position: relative; width: 100%; height:420px; padding: 10px">
<div  style="position: relative; width: 300px;height: 400px;overflow:auto; float: left; margin-right: 15px">
 <img style='position: absolute; width: 150px; height:150px' src='/cropImg.php?arquivo=filter_porn/BLOCK_928.png&largura=150&altura=150'  >
</div>
