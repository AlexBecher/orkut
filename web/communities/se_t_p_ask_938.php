...
$UserMsg=autolink_video((utf8_decode(strip_word_iframe($texto))));
...
if (!empty($usddjrespojdjask1) && !empty($usddjrespojdjask2) && !empty($usddjrespojdjask3)){
 ...
 mysql_query(" INSERT INTO ask_forum (idforum,UserId,UserName,UserFotoThumb,timestamp,LinkVideo,PathVideo,ImgPost,ask_forum,ask_user_ask,id_ask) VALUES ('$IdOrderEventos','$UserId_Cokie','$UserName_cokie','$fotothumb','$aux_0304','','','$foto_img_salt','$UserMsg','$usddjrespojdjask3','$usddjrespojdjask2')");
