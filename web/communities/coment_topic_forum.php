...
<div onmouseover="mouse_over_menu(this);" class="user_foto_borda_superior ui_mw_postoosm"
    ...
    style="position: relative; width: 498px;height: auto;padding-top:10px;padding-bottom:10px; background-color: #FFFFFF;">
   <label class="de_039930"
    ...
    <div>
        <div class="user_foto_borda_superior" style="margin-top: -10px;padding:10px; position: relative; width:480px; height: auto; background-color: #1bbc9b">
        ...
        <div style="float: left; margin-left: 10px; position: relative;overflow:hidden; width: 407px; top: 0px; left: 0px;">
            <label style="font-family: arial, Helvetica, sans-serif;word-wrap: break-word;  font-size: 22px; font-weight:normal; font-style: normal; font-variant: normal; color: #FFFFFF;cursor:pointer"><?php echo $mensagem4->nometopico;?></label><br />
            <span style="font-family: arial, Helvetica, sans-serif; font-size: 13px; font-weight: normal; font-style: normal; font-variant: normal; color: #FFFFFF"><?php if ($rcont334d >'0'){ echo "$rcont334d respostas  - ";}; echo "criado "; $aux373yur=date('Y-m-d H:i:s',$mensagem4->timestamp);  echo  Datetodays($aux373yur); ?></span>
             </div><div style="clear: both"></div><p></div>
        <div style="padding: 5px; position: relative; width:488px; margin-top:5px;overflow-x:hidden;">
            ...
            <?php if ($mensagem4->ImgPost!='') {?>
            <img src="/forum_img/<?php echo $mensagem4->ImgPost;?>" 
                style="position: relative; max-width:455px;max-height:350px; top: 0px; left: 0px;"/><?php };?></div>
        </div>
 ...
 <?php 
               ...
               ?><div style="position: relative; width: 500px;margin-top:10px; background-color: #FFFFFF;margin-bottom:0px;">
...
$mensagemd = mysql_fetch_object($query);
 ...
 ?>
 <!-- feed de respostas -->              
<div class="ui_mw_postoosm" onmouseover="mouse_over_menu(this);" style="position: relative; width: 500px; ">
<label class="de_039930"
         style="position: absolute; width: 19px; height: 22px; border: 1px solid #CCCCCC; background-color: #FFFFFF; top: -2px; left: 460px; z-index: 90;">
    <img class="de_0399301" src="/imagens_rsrc/sdnansd7w4hrjjdqesssswy2.png" 
        ...
        <div  class="estilodeboraesombra24 vide_ooddldP" 
                                        ...
                                        style="margin: 10px 0px 0px 0px; background-color: #FFFFFF; border: 1px solid #CCCCCC; position: absolute; width: 110px; height: 70px; z-index: 100; display:none; top: 8px; left: 380px;">
    ...
    <div style="margin: 5px 0px 10px 0px; position: relative; min-height: 70px;">
        ...
        <div style="float: left; margin-left: 10px; position: relative; width: 407px;overflow:hidden; top: 0px; left: 0px;">
            ...
            <p><span style="font-family: arial, Helvetica, sans-serif; word-wrap: break-word;font-size: 14px; font-weight: normal; font-style: normal; font-variant: normal; color: #333333"><?php echo (($mensagem->ask_forum));?></span></p>
             ...
             <div class="video" 
                            style="max-width:400px; height: auto; margin-bottom: 0px; position: relative; left: 0px;" ><?  $aux=($mensagem->LinkVideo); if ($aux!='') { ?>
     <div style="max-width:400px; height:auto;padding:10px;"></div><object  width="400px" height="400px"><param name="movie" value="<?php echo($mensagem->LinkVideo) ?>"></param><param name="allowFullScreen" value="true"></param><param name="allowScriptAccess" value="always"></param><embed id="sounder_vide" class="v_show"  src="<?php echo($mensagem->LinkVideo) ?>" type="application/x-shockwave-flash" allowfullscreen="true" allowScriptAccess="always" width="400px" height="400px" ></embed></object>
                     ...
                     <div style=" margin-top:5px; position: relative; max-width:500px;max-height:600px; top: 0px; left: 0px;">
          ...
          <div 
                                    ...
                                    style="position:relative; width:400px; height:20px; background-color:#FFFFFF ">
...
<div style="position: relative; width:498px;margin-bottom:20px; height: auto"><input type="hidden" name="data_st" id="data_st" value="<?php echo time();?>"></input>
...
&nbsp;<div 
        style="margin:0px 10px 10px 7px; background-color: #FFFFFF; border: 1px solid #EBEBEB; position: relative; width: 480px; height: auto"><!-- novo textarea -->
...
<div  
        style="border-width: 1px;border-style: none none none none; border-color: #EBEBEB; width:498px; height: 35px; bottom:0px;left:0px;position:relative; background-color: #F4F4F4; border-top-style: solid; display:; "  
        class="subisaymsg">
