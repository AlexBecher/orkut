...
$query55ds = mysql_query("SELECT  ask_forum.idorder FROM ask_forum,users where (users.UserId=ask_forum.UserId) and  idforum='$auc_cod' and users.UserId<>'".USERID_ID."'  order by ask_forum.idorder DESC ")or die(mysql_error());
