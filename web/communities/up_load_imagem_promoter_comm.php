...
include("date.php");
 ...
 $text0_uoppp2 = UPLOADDEIMAGEMPERFILERRO2;
 $text0_uoppp3 = UPLOADDEIMAGEMPERFILERRO3;
...
$extensao = pathinfo($_FILES["imagemN1"], PATHINFO_EXTENSION);
 
         if($extensao != 'gif')
                { 
if($arquivo)
{
if($_FILES['imagemN1']['size'] < $tamanho_arquivo){
...
<div  style="position: relative; width: 100%; height:220px; padding: 10px">
    <div style='position: absolute; width: 155px; height: auto; text-align: justify; top: 97px; left: 152px;'><label style='font-family: arial, Helvetica, sans-serif; font-size: 12px; font-weight: bold; font-style: normal; font-variant: normal; color: #666666; '  >$text0_uoppp2</label></div></div>      
...
<div  style="position: relative; width: 100%; height:220px; padding: 10px">
    <div style='position: absolute; width: 155px; height: auto; text-align: justify; top: 97px; left: 152px;'><label style='font-family: arial, Helvetica, sans-serif; font-size: 12px; font-weight: bold; font-style: normal; font-variant: normal; color: #666666; '  >$text0_uoppp3</label></div></div>      
