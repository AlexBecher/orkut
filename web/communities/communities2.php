...
" />
<link rel="image_src" href="https://orkuti.net/bg_community/<?php if ($mensagemcod->CommunityImg !=''){ echo $mensagemcod->CommunityImg;}else{ echo "iwu_poweo928C_093_large.jpg";};?>" />
...
<a href="https://orkuti.net/logout.php"><li class="men_new_90349e3 fon_fault_all _ldsi373773ytehhn" ><?php echo SAIRGERAL;?><img src="/img_news_2016/ic_vertical_align_bottom_black_48dp_2x.png"  class="sobre_icon_bar _oepoHHF44253g"  /></li></a></ul></div>
...
<div id="ser_user_people"></div></div></div><div style="clear: both;"></div></div>            
...
<!-- gender -->
<?php if ( USERID_ID=='1' || USERID_ID=='b3f7daa7df2718e2138767d5f7f9acce') { ?><div class="men_new_90349e _kIJ736_ji_jgBBN" ><label class="" onclick="clean_923r37com('<?php echo $mensagemcod->IdCommunity;?>');">Excluir comunidade</label></div><?php };?>
...
<!-- edit -->
<?php if ($mensagemcod->UserIdPro==USERID_ID && USERID_ID=='1'){?>
<!-- promova -->   
<div class="men_new_90349e _kIJ736_ji_jgBBN" >
<img  src="/img_communities/brandingpromote3.png" class="img_menu_83438" />
<label class="men_new99eje_normal"><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/my_promote?&pag=1"><?php echo PROMOVACOMMM883;?></a></label>
<div class="clear" ></div></div>
<!-- promova -->
<?php };?>
<!-- lixeira -->   
...
<label class="men_new99eje_normal"><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/laystall?&pag=1"><?php echo LIXEIRACOMMM883;?></a></label>
<div class="clear" ></div></div>
<!-- lixeira --><?php };?>
<?php if (($row_members_003==''  && $row_moderador03==''  && $row_baned_003=='' && $mensagemcod->CommunityPrivacy=='2'  && $mensagemcod->UserIdPro!=USERID_ID)|| ($rcont37mc > '0' && $row_members_003==''  && $row_moderador03==''  && $row_baned_003=='' && $mensagemcod->UserIdPro!=USERID_ID) ){?>
<!-- add -->   
<div class="men_new_90349e _kIJ736_ji_jgBBN" >
...
if ($_GET['topic']=='my_promote' && $_GET['id']!=''){
...
$querycodr2 = mysql_query("SELECT ccuserid,community_users.IdOrder FROM promoter,community_users  where (ccuserid='".CCUSERIDI."' and promoter.id=community_users.IdOrder) order by promoter.idorder ")or die(mysql_error());;
...
<span class="greujjie999"  ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/promote?&pag=1"><?php echo CRIARPROMOCOES0039;?></a></span></div> <div class="Kj889_csw63 _OO84IBOX_default"  >
<span class="jduieiijjwheblue" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/my_promote?&pag=1"><?php echo MINHASPROMOCOES03003;?></a></span></div><div  class="Kj889_csw63N _OO84IBOX_default" >
<span class="greujjie999" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/help_promote?&pag=1"><?php echo SABERSOBREPROMOCOES99393;?></a></span></div><div class="clear_div_0"></div></div>
...
<div class="box_002ooIO-01 d-0122O-a" ><div class="d-0122O-a2">
    ...
    <?php 
        //meus amigos viram
        $queryPromoter_views1 = mysql_query("SELECT users.ccuserid,friends_list.Idfriend,friends_list.Idme FROM users,friends_list force index(Idfriend) inner JOIN  view_promoter   ON (view_promoter.ccuserid=friends_list.Idfriend) where (users.ccuserid=friends_list.Idfriend and friends_list.Idme='".CCUSERIDI."' and friends_list.block<>'2' and view_promoter.idview_promoter='$row_promoter_fecht->idorder')  Order by idview ASC  ")or die(mysql_error()); 
        $row_Promoter_views1 = mysql_num_rows($queryPromoter_views1);
        //amigos de meus amigos que  viram
        $queryPromoter_views2 = mysql_query("SELECT friends_list.Idfriend FROM friends_list,view_promoter  where (view_promoter.ccuserid=friends_list.Idfriend and view_promoter.idview_promoter='$row_promoter_fecht->idorder') and (friends_list.Idme<>'".CCUSERIDI."' and friends_list.Idfriend<>'".CCUSERIDI."') and  friends_list.Idme in(SELECT friends_list.Idfriend FROM friends_list  inner JOIN  view_promoter   ON (view_promoter.ccuserid=friends_list.Idfriend) where (friends_list.Idme='".CCUSERIDI."' and friends_list.block<>'2' and view_promoter.idview_promoter='$row_promoter_fecht->idorder' )) group by Idme  Order by idview ASC ")or die(mysql_error()); 
        $row_Promoter_views2 = mysql_num_rows($queryPromoter_views2);
        //amigos em 3 ° grau que vira
        $count_row_do_friends_by=0;
        $lista_Promoter_views = array();
        while ($row_do_friends_by = mysql_fetch_object($queryPromoter_views2)){
        $lista_Promoter_views[] = $row_do_friends_by;
        
        };
         foreach ($lista_Promoter_views AS $row_do_friends_by2) { 
         
        $queryPromoter_viewsL = mysql_query("SELECT friends_list.Idfriend FROM friends_list,view_promoter  where (view_promoter.ccuserid=friends_list.Idfriend and view_promoter.idview_promoter='$row_promoter_fecht->idorder' and friends_list.Idme='".$row_do_friends_by2->Idfriend."' )group by Idme  limit 1")or die(mysql_error()); 
        $row_Promoter_viewsL = mysql_num_rows($queryPromoter_viewsL);
       // $row_do_friends_by55 = mysql_fetch_object($queryPromoter_viewsL);
        //echo $row_do_friends_by55->Idfriend."-".$row_do_friends_by2->Idfriend."<br>";
       if ($row_Promoter_viewsL <>''){
       $count_row_do_friends_by=$count_row_do_friends_by+1;
...
$row_Promoter_views4=$row_Promoter_views4+1;
        ...
        ?>
<div class="_6H-vxz23n" ><span class="_029HG87"><?php echo _rest_number($row_Promoter_views4)?> pessoas viram  </span></div>
<div class="box_001-jnzz">
<div class="box_001-jnzz0"><span  class="box_001-jnzz1"><?php echo _rest_number($row_Promoter_views1)?></span><span class="box_001-jnzz2"><?php echo _rest_number($row_Promoter_views2)?></span>
<span class="box_001-jnzz3"><?php echo _rest_number($count_row_do_friends_by)?></span><span class="box_001-jnzz4">+<?php echo _rest_number($row_Promoter_views4-($row_Promoter_views1+$row_Promoter_views2+$count_row_do_friends_by))?></span></div>
...
<?php 
     $url_m = "/".$url_teste_default."/".$_GET['id']."/my_promote";
    $prox = $pag + 1;
	$ant = $pag - 1;
...
<span class="jduieiijjwheblue"  ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/promote?&pag=1"><?php echo CRIARPROMOCOES0039;?></a></span></div> <div class="Kj889_csw63N _OO84IBOX_default"  >
<span class="greujjie999" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/my_promote?&pag=1"><?php echo MINHASPROMOCOES03003;?></a></span></div><div  class="Kj889_csw63N _OO84IBOX_default" >
<span class="greujjie999" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/help_promote?&pag=1"><?php echo SABERSOBREPROMOCOES99393;?></a></span></div><div class="clear_div_0"></div></div>
<div id="lweo94ialfejjfeqjkol">
<? 
...
<input type="hidden" id="nam_url_92" name="nam_url_92" value="/<?php echo $url_teste_default."/".$_GET['id']."/promote" ;?>">
<input type="hidden" id="nam_cod_comm93" name="nam_cod_comm93" value="<?php echo $mensagemcod->IdOrder;?>">
...
<div class="_6Vzxx"> <div id="Lk-28iw_vag2" class="radius_3px" style="border: 1px Solid #CCCC00; position: absolute;display:none; background-color: #fff1a6; text-align: center; padding: 5px 10px 5px 10px; width: auto; height: auto; right: 40%; top: -40px;"></div><label  onclick="window.location=/<?php echo $url_teste_default."/".$_GET['id']; ?>" class="_6Vzxx1 radius_3px"><?php echo CANCELARGERAL;?></label><label onclick="_8i_j_CXD('<?php echo $mensagemcod->IdOrder;?>',this,'<?php echo $url_teste_default."/".$_GET['id']."/my_promote?&pag=1" ;?>','<?php echo AGUARDE939I3JDH;?>','<?php echo CRIANDOPROMOCAO883UJDD;?>','<?php echo TEXTOMUITOCURTO2882;?>','<?php echo VOCEDEVEESCREVERUMADESCRICAO9292;?>','<?php echo COLOQUEUMAIMAGEM82872;?>','<?php echo $mensagemcod->category;?>');" class="_6Vzxx2 radius_3px"><?php echo CRIARPROMOCA52Y2JH;?></label><div class="clear"></div>
<div class="_4j350-n radius_3px" ><img  src="/img_communities/8iikrk030ppeorr22.png"/><div><span><?php echo SERA9292DNNDYASDHSD;?></b></span></p></div></div></div></div>
...
<div class="box-pagi-bottom-30" >
<?php 
     $url_m = "/".$url_teste_default."/".$_GET['id']."/promote";
    $prox = $pag + 1;
	$ant = $pag - 1;
	$ultima_pag = ceil($total / $limite);
	$penultima = $ultima_pag - 1;	
...
if ($_GET['topic']=='laystall' && $_GET['id']!=''){
...
<div class="L-boxo-links-commm"><span class="l-3883_span_po393"><a href="/"><?php echo INICIO030939KLOIK;?></a><font>&nbsp;>&nbsp;</font><a href="/cmm/category/<?php echo $mensagemcod->category;?>"><?php $querycod8343849 = mysql_query("SELECT text FROM category_communities  where category='$mensagemcod->category'  limit 1")or die(mysql_error());;
$mensagemcod783748347348387 = mysql_fetch_object($querycod8343849); echo $mensagemcod783748347348387->text;?></a><font>&nbsp;>&nbsp;</font><a href="/<?php echo $url_teste_default;?>/<?php echo $mensagemcod->IdOrder;?>"><?php echo ocultaTexto($mensagemcod->CommunityName,30);?></a><font>&nbsp;>&nbsp;</font><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/laystall?&pag=1"><?php echo  LIXEIRACOMMM883;?></a></span>
</div>
</div>


<div class="box-pagi-top-30" >
<div class="o-383s-spwi-2002n" ><div class="clear"></div></div>
<?php 
     $url_m = "/".$url_teste_default."/".$_GET['id']."/laystall?&cod=".$_GET['cod']."";
...
<div class="box-ask_h-3938kje"><?php echo (($row_forum->ask_forum));?><?php if ($row_forum->ImgPost!='') {?><center><img src="/forum_img/<?php echo $row_forum->ImgPost;?>"/></center><?php };?></div>
...
?>
 <a href="/<?php echo $row_name_7782->NikName ;?>"><div class="boradsemquina3 box-img-members-comm9"><img  src="/cropImg.php?arquivo=profile_img/<?php echo $row_name_7782->UserFotoThumb ;?>&largura=60&altura=60"/><label><?php echo ocultaTexto($row_name_7782->UserName,5); ?></label></div> </a> <?php };};?><div style="clear: both;"></div></div>        
