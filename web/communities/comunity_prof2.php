...
?>    
    ...
    <span style="font-family: arial, Helvetica, sans-serif; font-size: 20px; font-weight: normal; font-style: normal; font-variant: normal; color: #333333; position: absolute; top: 13px; left: 138px;"><?php if($idUseruNN9c==USERID_ID){ echo "Você  não tem mais comunidades para exibir:(";}else{ echo "$User_Name33 não tem mais comunidades para exibir:(";};?></span></div>
