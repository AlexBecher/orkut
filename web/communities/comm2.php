...
<link href="css/bootstrap_n.css" rel="stylesheet">
...
<link href="css/style_ny7uuw.css?v=<? echo time(); ?>" rel="stylesheet">
...
<button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#menu-mobile" aria-expanded="false" aria-controls="navbar">
<span class="sr-only">Toggle navigation</span>
<span class="icon-bar"></span>
<span class="icon-bar"></span>
<span class="icon-bar"></span>
</button>
<a href="javascript:void(0)" class="navbar-brand no-padding icon hide" id="btn-hide-search">
<i class="fa fa-arrow-left"></i>
</a>
<a class="navbar-brand navbar-brand-logo no-padding" href="/">
<div class="logo"></div>
</a>
<div class=" menu-form visible-xs hidden">
<form action="/" method="get" class="navbar-form navbar-right no-margin no-padding">
<div class="forms">
<div class="input-group">
<input type="hidden" name="exp" value="1" />
<input type="search" class="form-control" name="q" placeholder="pesquisa do orkuti">
...
<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="11617475637e2351617574637e3f727e7c">[email&#160;protected]</a></span>
</li>
<li><a href="/logout.php">Sair</a></li>
<li class="no-padding menu-form hidden-xs">
<form action="/" method="get" class="navbar-form navbar-right no-margin no-padding">
<div class="forms">
<div class="input-group">
<input type="hidden" name="exp" value="1" />
<input type="text" class="form-control" name="q" placeholder="pesquisa do orkuti">
<span class="input-group-btn">
<button class="btn btn-default" type="submit"><i class="fa fa-search"></i></button>
</span>
</div>
...
<label class="men_new99eje_normal"><a href="/<?php if ($rcont373wllele20!=''){ echo $url_teste_default;?>/<?php echo $_GET['id'];?>/my_promote?&pag=1"><?php }else{ echo $url_teste_default;?>/<?php echo $_GET['id'];?>/help_promote?&pag=1"><?php } echo PROMOVACOMMM883;  ?></a></label>
<div class="clear" ></div></div>
<!-- promova -->
<?php };?>
<!-- lixeira -->   
...
if ($_GET['topic']=='help_promote' && $_GET['id']!=''){
...
<span class="greujjie999"  ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/promote?&pag=1"><?php echo CRIARPROMOCOES0039;?></a></span></div> <div class="Kj889_csw63N _OO84IBOX_default"  >
<span class="greujjie999" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/my_promote?&pag=1"><?php echo MINHASPROMOCOES03003;?></a></span></div><div  class="Kj889_csw63 _OO84IBOX_default" >
<span class="jduieiijjwheblue" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/help_promote?&pag=1"><?php echo SABERSOBREPROMOCOES99393;?></a></span></div><div class="clear_div_0"></div></div>
...
<div class="_3a3h _2vg3 _029jj_ki28-99"><div class="_38io _3m9 _029jj_ki28-99"><?php echo  TEXTO00043994OROKRJRJUR;?> </div><a class="_42ft _2qix _7tn _3ma" role="button" href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/promote?&pag=1" id="u_0_c"><?php echo  CRIARPROMOCAO9902;?></a></div>
...
if ($_GET['topic']=='reported' && $_GET['id']!=''){
...
<span class="greujjie999" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/banned?&pag=1"><?php echo MEMBROSBANIDOS44;?></a></span></div><?php };?>
<?php if (($rcont373wllele!='' or $rcont373e!='') && $aux_id_profile=='1') {?><div  class="Kj889_csw63 _OO84IBOX_default" >
<span class="jduieiijjwheblue" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/reported?&pag=1">Denunciados</a></span></div><?php };?> <div class="clear_div_0"></div></div>
<div id="lweo94ialfejjfeqjkol">
<? 
if ($rcont37!=''){
...
<div class="box-pagi-bottom-30" >
<?php 
     $url_m = "/".$url_teste_default."/".$_GET['id']."/reported";
    $prox = $pag + 1;
	$ant = $pag - 1;
	$ultima_pag = ceil($total / $limite);
	$penultima = $ultima_pag - 1;	
...
<span class="jduieiijjwheblue" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/banned?&pag=1"><?php echo MEMBROSBANIDOS44;?></a></span></div><?php };?> 
<?php if (($rcont373wllele!='' or $rcont373e!='') && $aux_id_profile=='1') {?><div  class="Kj889_csw63 _OO84IBOX_default" >
<span class="greujjie999" ><a href="/<?php echo $url_teste_default;?>/<?php echo $_GET['id'];?>/reported?&pag=1">Denunciados</a></span></div><?php };?><div class="clear_div_0"></div></div>
<div id="lweo94ialfejjfeqjkol">
<? 
if ($rcont37!=''){
...
if ($_GET['topic']=='edit_topic' && $_GET['cod']!='0'  && $_GET['id']!='' && ($row_my_com88 !='' || $row_moderador03!='')){
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-166808403-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-166808403-1');
</script>
</body></html>
