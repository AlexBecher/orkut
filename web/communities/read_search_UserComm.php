 ...
 <div   onmouseover="mouse_over_menu(this);"  class="ui_mw_postoosm sombra_padrao_bottom"
    ...
    style="margin: 10px 0px 0px 0px; background-color: #FFFFFF; border: 1px solid #CCCCCC; position: absolute; width: 150px; height:auto; z-index: 100; display:none; top: 8px; left:120px;">
     ...
     <div style="position: relative; width: 148px; height: 80px; float: left; margin-left: 10px; top: 0px; left: 0px; padding-top: 10px;">
         <label onclick="view_prof('<?php echo $mensagem->idusers ;?>')" style="font-family: arial, Helvetica, sans-serif;word-wrap: break-word; font-size: 13px; font-weight: bold; font-style: normal; font-variant: normal; color: #333333; position: relative"><?php echo $fotocomp2Idnome;?></label></div>  
    ...
    <img src="/img/oopeiYTHG883.png" 
        ...
        style="color: #FFFFFF; font-family: arial, Helvetica, sans-serif; font-size: 13px; font-weight: bold; font-style: normal; font-variant: normal; position: absolute; top: 11px; left: 8px;">Moderador</span></div> <?php };?></div>
