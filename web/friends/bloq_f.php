...
?>
<div id="ooiere77465DFDEE" style="position: relative; width: 500px; min-height:30px;"></div><div style="clear:both"></div>  
<?
//friends list
              $query17p = mysql_query("SELECT Idfriend FROM black_list_friends  Where (Idme='".CCUSERIDI."' and Idfriend<>'')   order by idorder DESC limit 9 ");
...
<?php if ($rcont37p >'8'){?><div style="clear:both"></div>
 <div id="MsgPostM444"></div>
<div id="limit_pag2" 
                  
                  
                  
                        
         style="border: 1px solid #CCCCCC; width: 450px; height: 40px; background-color: #F4F4F4; position: relative; left: 25px; top:5px;"><center><label class="link_foote"  onclick="carrega_mais2277BB('<?php echo $UserId_Cokie;?>')"><label id="mais_post1"><span style="font-family: tahoma; font-size: 11px; font-weight: normal; font-style: normal; font-variant: normal; color: #336699" 
                      >Mais</span></label><div id="load_1"></div></label></center></div>
<?php };  }
 else{
