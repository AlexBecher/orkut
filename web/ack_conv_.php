...
require ("check_func_db.php");
 ...
 if (login_chekout()==true && CCUSERIDI!='551519'){
  sec_session_start();
...
if ($_POST['cod']!=''){
$idookoko00=Sanitize::filter($_POST['cod']);
 mysql_query("DELETE  FROM notificacao_user    where IdOrder='$idookoko00' and UserId='$UserId_Cokie'limit 1 ")or die(mysql_error());  
 
}
mysql_query("UPDATE  notificacao_user Set readNoti='yes' Where UserId='$UserId_Cokie'  ")or die(mysql_error());; 
